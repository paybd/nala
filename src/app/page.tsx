    ...
    <div className="font-sans">
      ...
      <section className="relative bg-neutral-50 min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="/pi_business_v5.apk" className="mt-6 inline-flex items-center justify-center rounded-full bg-[#218A48] hover:bg-[#1a6b38] text-white px-6 py-3 text-sm font-medium transition">এখনই ডাউনলোড করুন</a>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <a href="/pi_business_v5.apk" className="mt-8 inline-flex items-center justify-center rounded-full bg-[#218A48] hover:bg-[#1a6b38] px-8 py-3 text-base font-medium shadow-lg transition">
