...
export default function Faq() {
  return (
    <Accordion
      items={[
        { id: "q1", question: "PI Business কী?", answer: "একটি আন্তর্জাতিক মানি ট্রান্সফার অ্যাপ, যার মাধ্যমে UK, US ও EU এবং Middle East থেকে বিশ্বের নানা দেশে সহজে টাকা পাঠানো যায়।" },
        ...
        { id: "b1", question: "PI Business কীভাবে কাজ করে?", answer: "বিভিন্ন দেশ এ রিসেলার নিয়োগ দিয়ে বাল্ক এক্সচেঞ্জ রেট দেওয়ার মাধ্যমে PI Business সম্প্রসারণ করে " },
        ...
        { id: "b3", question: "বিজনেস রেট কীভাবে পাবো?", answer: (
          <span>
            আমাদের টিমের সাথে কথা বলতে <a className="underline" href="https://wa.me/?text=আমি PI Business রেট জানতে চাই" target="_blank" rel="noopener noreferrer">WhatsApp-এ বার্তা দিন</a>।
          </span>
        ) },
      ]}
      defaultOpenId="q1"
